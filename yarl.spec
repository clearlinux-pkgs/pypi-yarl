...
Source0  : https://files.pythonhosted.org/packages/76/ac/3809535fa339be876bf5938bc82217b26fac27ef1138d502bcb2af9278e1/yarl-1.6.0.tar.gz
...
%prep
%setup -q -n yarl-1.6.0
cd %{_builddir}/yarl-1.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600885043
...
cp %{_builddir}/yarl-1.6.0/LICENSE %{buildroot}/usr/share/package-licenses/yarl/629aef675d0010dc7bc7e08ef043868759e5fd09
