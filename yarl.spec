...
Source0  : https://files.pythonhosted.org/packages/ac/dd/59768bb3fa08e8b23e91575bca3ff8d2edbfbceebec8c59eaa24c4215791/yarl-1.5.1.tar.gz
...
%prep
%setup -q -n yarl-1.5.1
cd %{_builddir}/yarl-1.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596476332
...
cp %{_builddir}/yarl-1.5.1/LICENSE %{buildroot}/usr/share/package-licenses/yarl/629aef675d0010dc7bc7e08ef043868759e5fd09
