...
Version  : 1.8.0
Release  : 32
URL      : https://files.pythonhosted.org/packages/37/99/a872464316f791ff59e83cb99c6a0224ee93498455a8f0080eb05f3f8cc6/yarl-1.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/37/99/a872464316f791ff59e83cb99c6a0224ee93498455a8f0080eb05f3f8cc6/yarl-1.8.0.tar.gz
...
%prep
%setup -q -n yarl-1.8.0
cd %{_builddir}/yarl-1.8.0
pushd ..
cp -a yarl-1.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659393758
