...
Source0  : https://files.pythonhosted.org/packages/4b/d5/0d0481857de42a44ba4911f8010d4b361dc26487f48d5503c66a797cff48/yarl-1.17.2.tar.gz
...
%prep
%setup -q -n yarl-1.17.2
cd %{_builddir}/yarl-1.17.2
pushd ..
cp -a yarl-1.17.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731949697
