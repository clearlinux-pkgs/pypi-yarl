...
Source0  : https://files.pythonhosted.org/packages/b7/9d/4b94a8e6d2b51b599516a5cb88e5bc99b4d8d4583e468057eaa29d5f0918/yarl-1.18.3.tar.gz
...
%prep
%setup -q -n yarl-1.18.3
cd %{_builddir}/yarl-1.18.3
pushd ..
cp -a yarl-1.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739828000
