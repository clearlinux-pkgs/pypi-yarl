...
Source0  : https://files.pythonhosted.org/packages/23/52/e9766cc6c2eab7dd1e9749c52c9879317500b46fb97d4105223f86679f93/yarl-1.16.0.tar.gz
...
%prep
%setup -q -n yarl-1.16.0
cd %{_builddir}/yarl-1.16.0
pushd ..
cp -a yarl-1.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730150086
