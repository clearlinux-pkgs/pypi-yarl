...
Source0  : https://files.pythonhosted.org/packages/62/51/c0edba5219027f6eab262e139f73e2417b0f4efffa23bf562f6e18f76ca5/yarl-1.20.0.tar.gz
...
%prep
%setup -q -n yarl-1.20.0
cd %{_builddir}/yarl-1.20.0
pushd ..
cp -a yarl-1.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744898493
