...
Source0  : https://files.pythonhosted.org/packages/fc/4d/8a8f57caccce49573e567744926f88c6ab3ca0b47a257806d1cf88584c5f/yarl-1.19.0.tar.gz
...
%prep
%setup -q -n yarl-1.19.0
cd %{_builddir}/yarl-1.19.0
pushd ..
cp -a yarl-1.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744039576
