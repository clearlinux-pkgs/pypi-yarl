...
Source0  : https://files.pythonhosted.org/packages/7f/47/ab72cdc3e44a759c76596ae034e0c60f2c2b16fa220895dc4cb1c8a6c162/yarl-1.12.1.tar.gz
...
%prep
%setup -q -n yarl-1.12.1
cd %{_builddir}/yarl-1.12.1
pushd ..
cp -a yarl-1.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727367215
